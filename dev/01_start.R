...
golem::fill_desc(
  pkg_name = "shinygolemtest", # The Name of the package containing the App 
  pkg_title = "Shiny Golem Test", # The Title of the package containing the App 
  pkg_description = "PKG_DESC.", # The Description of the package containing the App 
  author_first_name = "AUTHOR_FIRST", # Your First Name
  author_last_name = "AUTHOR_LAST",  # Your Last Name
  author_email = "AUTHOR@MAIL.COM",      # Your Email
  repo_url = "https://github.com/AlexandraKapp/golemtest.git" # The (optional) URL of the GitHub Repo
)     
